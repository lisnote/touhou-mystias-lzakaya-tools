...
export const dishes: Dish[] = [
  {
    ...
    features: ['水产', '饱腹', '招牌', '适合拍照', '小巧'],
    missingFeatures: [],
    cookingTime: 4.8,
    unlock: '',
    description: '听说也是外界流行的街边小吃，在特制的面糊中裹上引发奇迹的章鱼脚，糯脆的外衣之下反弹的章鱼脚产生让人幸福的感觉。',
  },
  {
    name: '巨人玉子烧',
    cookware: '油锅',
  ...
  },
  {
    ...
    cookingTime: 4.8,
    unlock: '',
    description: '选用新鲜鲜鳟鱼与海带保煮而成的味噌汤，浓浓的鲜味四处漂荡，鲜而不腥。',
  },
  {
    name: '黄金酥鱼饼',
    cookware: '油锅',
