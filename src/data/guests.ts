...
export const guests: Guest[] = [
  ...
  {
    name: '二岩瑞藏',
    locations: ['妖怪兽道', '人类村落', '博丽神社', '命莲寺', '神灵庙'],
    balance: [1000, 1200],
    likedDishTraits: [
      '肉',
      '水产',
    ...
    unlikedDishTraits: ['灼热', '辣'],
    likedBeverageTraits: ['古典', '可加热', '烧酒', '高酒精'],
    type: 'special',
  },
  {
    name: '古明地恋',
    locations: ['特殊'],
    balance: [800, 1200],
    likedDishTraits: ['甜', '咸', '生', '猎奇', '不可思议', '梦幻'],
    unlikedDishTraits: [],
    likedBeverageTraits: ['气泡', '苦', '高酒精', '烧酒'],
    type: 'special',
  },
  {
    name: '八尺大人',
